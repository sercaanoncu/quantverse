...
def build_methodology_source_check() -> pd.DataFrame:
    ...
    rows = [
        ...
        _method(
            ...
            "Not proof of high return and sensitive to covariance quality.",
            "Risk contribution, volatility, drawdown.",
            "Presenting risk balance as guaranteed return improvement.",
            "actually_run_in_v2_with_public_data",
            "Keep risk contribution and out-of-sample evidence visible.",
        ),
        _method(
            "HRP",
            ...
            "Not a guaranteed return winner and dependent on correlation history.",
            "OOS risk, drawdown, cluster stability.",
            "Promoting HRP only because in-sample Sharpe is high.",
            "actually_run_in_v2_with_public_data",
            "Retain only while model-selection and history-integrity gates pass.",
        ),
        _method(
            "Black-Litterman",
            "Portfolio Optimization",
        ...
        _method(
            ...
            "Public-provider FX still lacks institutional vendor reconciliation.",
            "FX status, converted return audit.",
            "Mixing local returns as USD.",
            "implemented_with_public_data_provider_limits",
            "Add independent vendor/calendar reconciliation before institutional promotion.",
        ),
        _method(
            ...
            "Provider FX gaps or wrong quote direction invalidate conversion.",
            "FX normalization report.",
            "Promoting USD result from mixed returns.",
            "implemented_with_explicit_local_and_usd_outputs",
            "Retain quote-direction, calendar and compounding checks.",
        ),
        _method(
            "market-cap ranking",
        ...
        _method(
            "security identity and ticker reuse",
            "Machine Learning for Algorithmic Trading; portfolio-data governance; official exchange and regulatory notices",
            "Ticker symbols are time-varying routing labels; known reuse requires issuer/security identifiers and an effective listing boundary.",
            "Historical prices are linked to one verified legal security or documented predecessor chain.",
            "Ticker-only matching, unresolved relisting or unrelated prior symbol ownership.",
            "Identity audit, stable identifier, listing date and pre-listing observation count.",
            "Attributing a prior fund or issuer history to the current security.",
            "implemented_with_manual_primary_source_overrides",
            "Expand dated security-master coverage and independent reference-data reconciliation.",
        ),
        _method(
            "IPO and feature history sufficiency",
            "Portfolio Optimization; Introduction to Statistical Learning; Machine Learning for Algorithmic Trading",
            "A feature is eligible only when its stated lookback is fully observed before the scoring date.",
            "Common-history cross-sectional ranking and chronological walk-forward evaluation.",
            "Renaming a few weeks of observations as a 12-month statistic.",
            "Per-feature observation thresholds and standard-score eligibility.",
            "Mixing short-history diagnostics into the seasoned standard ranking.",
            "implemented_conservative_standard_exclusion",
            "Keep short-history securities visible as diagnostic-only until 252 valid returns exist.",
        ),
    ]
